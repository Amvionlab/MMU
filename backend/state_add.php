...
if ($action == "getAllLocations") {
    ...
    $sql = "SELECT id, name, is_active FROM state";
    ...
    $getStatusSql = "SELECT is_active FROM state WHERE id = ?";
    ...
    $updateStatusSql = "UPDATE state SET is_active = ? WHERE id = ?";
    ...
    $checkSql = "SELECT id FROM state WHERE name = ?";
    ...
    if ($stmt->num_rows > 0) {
        ...
        $insertSql = "INSERT INTO state (name, is_active) VALUES (?, ?)";
        $isActive = 1;
    ...
    $checkSql = "SELECT id FROM state WHERE name = ? AND id != ?";
    $stmt = $conn->prepare($checkSql);
    ...
    if ($stmt->num_rows > 0) {
        ...
        $updateSql = "UPDATE state SET name = ? WHERE id = ?";
