...
if ($action == "getAllLocations") {
    ...
    $sql = "SELECT id, name, is_active FROM location";
    ...
    $getStatusSql = "SELECT is_active FROM location WHERE id = ?";
    ...
    $updateStatusSql = "UPDATE location SET is_active = ? WHERE id = ?";
    ...
    if ($stmt->num_rows > 0) {
        ...
        $insertSql = "INSERT INTO location (name, is_active) VALUES (?, ?)";
        $isActive = 1;
    ...
    $checkSql = "SELECT id FROM location WHERE name = ? AND id != ?";
    $stmt = $conn->prepare($checkSql);
    ...
    if ($stmt->num_rows > 0) {
        ...
        $updateSql = "UPDATE location SET name = ? WHERE id = ?";
