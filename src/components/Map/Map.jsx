        ...
        {filteredVehicles.length > 0 ? (
          filteredVehicles.map(vehicle => (
            <div key={vehicle.deviceId} style={{ marginBottom: '15px', borderRadius: '5px', padding: '10px' }} className='leading-8 ml-4'>
              ...
              <div className='mt-2'> <p><strong className='text-prime'>Current Location:</strong> <br />{vehicle.address}</p></div>
              ...
              <div className='mt-2'> <p><strong className='text-prime'>Ignition Status:</strong> <br /> {vehicle.ignitionStatus} </p></div>
