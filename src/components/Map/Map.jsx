  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch('https://app.gpstrack.in/api/get_current_data?token=arishthe_zqIZhBqL1VMkcyC4qlH2uA6cpox7qqhD&email=arishtheboss5133@gmail.com');
  ...
  return (
    <div className='p-0.5'>
      <MapContainer center={currentLocation} zoom={6} style={{ height: '625px', width: '100%' }}>
        ...
        {/* Only render markers if vehicles are available */}
        ...
        {/* Connect vehicle positions with polyline only if there are vehicles */}
