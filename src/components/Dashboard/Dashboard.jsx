...
function Dashboard() {
  ...
  return (
    <main className="bg-white font-poppins p-4">
      <h2 className="flex gap-4 items-center text-2xl font-semibold mt-8"><RiDashboardHorizontalLine />MMU Dashboard</h2>
    <div className="h-full w-full px-10 pt-10 pb-10 bg-white grid grid-cols-2 gap-3">

      
      {data.map((val, i) => (
        <div key={i} className="bg-red-100 p-4 flex justify-between rounded-sm">
          {/* Left Section */}
