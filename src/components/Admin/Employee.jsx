...
const handleRowsPerPageChange = (e) => {
  ...
  return (
    <div className="bg-second max-h-full max-w-full h-full text-xs mx-auto p-1 lg:overflow-y-auto ticket-scroll">
     
      {showForm && (
        <div className="max-w-full h-full -mt-1 mb-2 p-2 bg-box rounded-lg font-mont " >
       ...
       <div className="max-w-full w-full h-full -mt-1.5 bg-box p-5 rounded-lg font-mont">
    <div className="ticket-table mt-4">
        ...
        <Table className="min-w-full filter-table">
  <TableHead>
    <TableRow className=" font-semibold font-poppins text-fontadd text-nowrap">
      {[
        "Id",
        "First Name",
        "Last Name",
        ...
        <TableCell key={index} align="center" className="w-1/10 py-4 px-4">
          <div className="flex items-center gap-2">
            <span className="head font-semibold">{header}</span>
  ...
  <TableBody>
    {currentTickets.map((userdet) => (
      <TableRow key={userdet.id} className="bg-box text-fontadd text-center font-medium">
        <TableCell className="border-t py-4 px-4">{userdet.id}</TableCell>
        <TableCell className="border-t py-4 px-4">{userdet.firstname}</TableCell>
        <TableCell className="border-t py-4 px-4">{userdet.lastname}</TableCell>
        <TableCell className="border-t py-4 px-4">{userdet.mobile}</TableCell>
        <TableCell className="border-t py-4 px-4">{userdet.email}</TableCell>
        <TableCell className="border-t py-4 px-4">{getNameById(userdet.branch, locations)}</TableCell>
        <TableCell className="border-t py-4 px-4">{userdet.employee_id}</TableCell>
        <TableCell className="border-t py-4 px-4">{userdet.department}</TableCell>
        <TableCell className="border-t py-4 px-4">{userdet.designation}</TableCell>
      </TableRow>
    ))}
  </TableBody>
</Table>
