...
const Form = () => {
        ...
        <div className="max-w-5xl m-2 mb-4 bg-box p-3 rounded-lg font-mont " >
          <div className="ticket-table mt-2">
            <form onSubmit={handleSubmit} className="space-y-4 text-label">
             ...
             <div className="flex items-center mb-2 mr-4">
              ...
              <select
                ...
                onChange={handleChange}
                required
                className="flex-grow text-xs bg-second border p-1 border-none rounded-md outline-none focus:border-bgGray focus:ring-bgGray w-1/6"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 ml-20 pr-20">
              <div className="mb-4 mr-4 md:mr-0 md:w-4/6 flex justify-center items-center">
              <div className="w-full md:w-full">
                <label className="block font-semibold text-prime mb-2 font-mont text-base">
                  Description 
                </label>
                <textarea
                  name="description"
                  ...
                  onChange={handleChange}
                  className="w-full text-base h-16 bg-second border-1 p-1 border-none rounded-md outline-none transition ease-in-out delay-150 focus:shadow-[0_0_6px_#5fdd33]"
                ></textarea>
              </div>
              <button
                  type="submit"
      ...
      <div className="max-w-5xl m-2 bg-box p-3 rounded-lg font-mont">
       <div className="flex justify-end flex-wrap space-x-2 mt-4">
        ...
        <div className="ticket-table mt-8">
          <h2 className="text-2xl font-bold text-prime mb-4"><span>SLA Data </span><span className="items-end"><button
  ...
  <thead className="bg-prime text-white">
    <tr>
      {["Id", "level","customer_id" ,"description", "hour"].map((header, index) => (
  ...
  <tbody>
    {currentTickets.map((user) => (
      <tr key={user.id} className="hover:bg-gray-100">
        ...
        <td className="border-t py-4 px-4">{user.level}</td>
        <td className="border-t py-4 px-4">{user.customer_name}</td>
        <td className="border-t py-4 px-4">{user.description}</td>
        <td className="border-t py-4 px-4">{user.hour}</td>
